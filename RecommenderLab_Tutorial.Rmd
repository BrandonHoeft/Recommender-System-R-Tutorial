...
knitr::opts_chunk$set(fig.width=7, fig.height=5, echo=TRUE, warning=FALSE, message=FALSE, comment = '')
```
...
The `realRatingMatrix` is about 9 times more efficient in conserving memory than a traditional matrix object.
